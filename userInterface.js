  ...
  static removeToDoLists() {
    ...
    dustbin.forEach((bin) => {
      bin.addEventListener('click', (e) => {
        ...
        LocalStorage.removeToDoLists(e.target.parentElement.previousElementSibling.children[1].value,
          );
  ...
  static updateDesc() {
    ...
    desc.forEach((elt) => {
      elt.addEventListener('change', (e) => {
        LocalStorage.updateDesc(e.target.value, e.target.parentElement.parentElement.id,
          );
      });
    });
  }
